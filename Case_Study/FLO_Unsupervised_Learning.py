...
# Carpıklık durumunu inceleyelim:
...
# Sağa carpık (sola yıgılımlı) dagılım sözkonusu. (mod<medyan<aritmetik ortalama)
# Carpıklık sözkonusu ise logaritma dönüşümü yapılmalıdır.
...
# K-MEANS
#-----------
# kume sayısı belirlenir.
# rastgele k merkez secilir. (rastgele k gözlem secilir.)
# her bir gözlem için k merkezlere uzaklıkları hesaplanarak gözlem, en yakın olan merkeze atanır.
# atama işleminden sonra kümeler için tekrar merkez hesaplaması yapılır. o kümedeki gözlemlerin merkeze uzaklıkları hesaplanır.
# kumelerin kendi içlerindeki uzaklıklarının toplamının toplamı minimum oldugu noktada uygun kumeleme yapımıs olur.
...
hc_complete = linkage(model_df, 'complete') #birleştirici bir clustering yontemi
